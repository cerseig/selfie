const voiceSprite = {
  ...
  posing_rotationLeft_errorTooMuch: [191000, 700], // end: 191700
  posing_rotationLeft_errorTooMuch_1: [192000, 1000], // end: 193000
  posing_rotationLeft_errorOpposite: [189000, 1200], // end: 190200
  posing_rotationLeft_errorNotEnough: [194000, 1000], // end: 195000
  posing_rotationLeft_errorNotEnough_1: [196000, 1100], // end: 197100
  posing_rotationRight_advice: [198000, 4000], // end: 202000
  posing_rotationRight_errorTooMuch: [191000, 700], // end: 191700
  posing_rotationRight_errorTooMuch_1: [192000, 1000], // end: 193000
  posing_rotationRight_errorOpposite: [36000, 1300], // end: 190200
  posing_rotationRight_errorNotEnough: [194000, 1000], // end: 195000
  posing_rotationRight_errorNotEnough_1: [196000, 1100], // end: 197100
  posing_rotationRight_success: [203000, 2100], // end: 205100
  posing_tiltRight_advice: [226000, 1700], // end: 227700
  posing_tiltRight_errorTooMuch: [191000, 700], // end: 191700
  posing_tiltRight_errorTooMuch_1: [192000, 1000], // end: 193000
  posing_tiltRight_errorNotEnough: [194000, 1000], // end: 195000
  posing_tiltRight_errorNotEnough_1: [196000, 1100], // end: 197100
  ...
  posing_rotationUp_errorTooMuch: [191000, 700], // end: 191700
  posing_rotationUp_errorTooMuch_1: [192000, 1000], // end: 193000
  posing_rotationUp_errorNotEnough: [194000, 1000], // end: 195000
  posing_rotationUp_errorNotEnough_1: [196000, 1100], // end: 197100
  posing_rotationDown_advice: [236000, 1800], // end: 237800
  posing_rotationDown_errorTooMuch: [191000, 700], // end: 191700
  posing_rotationDown_errorTooMuch_1: [192000, 1000], // end: 193000
  posing_rotationDown_errorNotEnough: [194000, 1000], // end: 195000
  posing_rotationDown_errorNotEnough_1: [196000, 1100], // end: 197100
  posing_rotationDown_success: [239000, 500], // end: 239500
  posing_eyeBrowLeftUp_advice: [240000, 2400], // end: 242400
  posing_eyeBrowLeftUp_errorNotEnough: [194000, 1000], // end: 195000
  posing_eyeBrowLeftUp_errorNotEnough_1: [196000, 1000], // end: 197100
  posing_eyeBrowLeftUp_success: [243000, 1500], // end: 244500
  posing_smileLeft_advice: [246000, 1700], // end: 247700
  posing_smileLeft_errorNotEnough: [249000, 3600], // end: 252600
  posing_smileLeft_errorNotEnough_1: [196000, 1000], // end: 197100
