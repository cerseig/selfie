const voiceSprite = {
  ...
  detection_center_error: [26000, 5200], // end: 31200
  ...
  posing_rotationLeft_errorNotEnough_1: [194000, 1000], // end: 195000
  posing_rotationLeft_errorNotEnough_2: [196000, 1100], // end: 197100
  ...
  posing_rotationRight_errorNotEnough_1: [194000, 1000], // end: 195000
  posing_rotationRight_errorNotEnough_2: [196000, 1100], // end: 197100
  ...
  posing_tiltRight_errorNotEnough_1: [194000, 1000], // end: 195000
  posing_tiltRight_errorNotEnough_2: [196000, 1100], // end: 197100
  posing_tiltRight_success: [229000, 2400], // end: 231400
  posing_smile_advice: [206000, 1100], // end: 207100
  posing_smile_errorNotEnough: [208000, 1300], // end: 209300
  posing_smile_success: [210000, 1600], // end: 211600
  posing_mouthOpenSmile_advice: [212000, 1200], // end: 213200
  posing_mouthOpenSmile_errorNotEnough: [215000, 1500], // end: 216500
  ...
  posing_rotationUp_errorNotEnough_1: [194000, 1000], // end: 195000
  posing_rotationUp_errorNotEnough_2: [196000, 1100], // end: 197100
  ...
  posing_rotationDown_errorNotEnough_1: [194000, 1000], // end: 195000
  posing_rotationDown_errorNotEnough_2: [196000, 1100], // end: 197100
  posing_rotationDown_success: [239000, 500], // end: 239500
  posing_eyeBrowLeftUp_advice: [240000, 2400], // end: 242400
  posing_eyeBrowLeftUp_errorNotEnough_1: [194000, 1000], // end: 195000
  posing_eyeBrowLeftUp_errorNotEnough_2: [196000, 1000], // end: 197100
  posing_eyeBrowLeftUp_success: [243000, 1500], // end: 244500
  posing_smileLeft_advice: [246000, 1700], // end: 247700
  posing_smileLeft_errorNotEnough_1: [249000, 3600], // end: 252600
  posing_smileLeft_errorNotEnough_2: [196000, 1000], // end: 197100
